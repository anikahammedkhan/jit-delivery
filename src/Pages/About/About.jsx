...
const About = () => {
  return (
    <div className="lg:top-[-50px] md:top-[-30px] top-[-20px] relative -z-0">
      ...
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
        <span className="text-orange-600">JIT DELIVER</span> is among
        Bangladesh’s leading organizations providing reliable and timely packing
        and moving services. We are documented best within the industry as top
        and efficient packers and movers in Dhaka Division and every one over
        Bangladesh for shifting and relocation services, warehousing services,
        industrial relocation, and office shifting services. Packing and moving
        is always a troublesome
      </p>
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
        Task we’d like to seem at how costly household goods are often kept
        safe. We’ve built up a reputation over the years that have inspired our
        customers to return back to us time and time again.
      </p>
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
      ...
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
        ...
        transportation. the corporate looks forward to expanding its operations
        to varied areas counting on the increasing demands of consumers.
      </p>
      <h1 className="text-center font-bold text-4xl my-10">
        PLANNING TO TRANSFER YOUR GOODS?
      </h1>
      <p className="w-4/5 mx-auto text-xl font-semibold my-4 text-center">
      ...
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
        ...
        platform for locating the simplest packers and movers in your region who
        can make the method safe and cozy.
      </p>
      <p className="w-4/5 mx-auto text-xl font-semibold my-4">
        We’ve many valued customers who showed us their firm faith and
        confidence. you’ll read the reviews on{" "}
        <span className="text-orange-600">JIT DELIVER</span>, check the ratings
        and choose a service provider supported their experience and services
        offered, and most significantly, under your budget.
      </p>
    </div>
  );
};
