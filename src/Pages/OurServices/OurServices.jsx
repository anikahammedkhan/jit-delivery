    ...
    <div className="lg:top-[-50px] md:top-[-30px] top-[-20px] relative -z-0">
      ...
      >
        ...
        <div className="card-body xl:w-1/2">
          ...
          <p>
            ...
            cartons, boxes, and tapes are used very carefully. We are engaged in
            offering a best-quality range of Packing & moving services to our
            clients, partners, and stakeholders. Goods are sealed properly
      ...
      >
        ...
        <div className="card-body xl:w-1/2">
          ...
          <p>
            ...
            assistance, expertise, and resources to optimize the operations and
            management of a warehouse facility. This service is typically
            offered by third-party providers or as a specialized department
            within a company. Its goal is to ensure the smooth functioning of
            day-to-day warehouse activities, improve efficiency, and enhance
            overall productivity.
          </p>
          <p>
            <span className="font-bold">Operational Guidance:</span> Providing
            advice and recommendations on warehouse layout optimization,
            inventory management strategies, order-picking methodologies, right
            dispatch ensured, invoice controlled, and other operational aspects.
            This guidance is aimed at improving efficiency and reducing
            bottlenecks.
          </p>
          <p>
            <span className="font-bold">Process Improvement:</span> Conducting
            regular assessments of warehouse processes to identify areas for
            improvement. This could involve analyzing data, identifying
            inefficiencies, and proposing changes to streamline operations.
          </p>
          <p>
            <span className="font-bold">Inventory Management: </span> Assisting
            in maintaining accurate inventory records system vs. physical
            accuracy, conducting regular cycle physical counts, and ensuring
            that stock levels are aligned with the system. This helps prevent
            overstocking, stock outs, and discrepancies in inventory levels.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-body xl:w-1/2">
          ...
          <p>
            ...
            household goods is completed timely without causing any anxiety to
            our customers.
          </p>
          <p>
            We train our employees in a way that they handle all the products
            very carefully without posing any harm to them. Our skilled
            workforce would never let your precious belongings undergo any kind
            of damage. In such a scenario, the fragile items will certainly
            break. Our company has been productive in providing skilled Loading
            and Unloading Services. With the help of our skillful skilled
            laborers, we provide safe loading and unloading of our client’s
            goods.
          </p>
          <p>
            Our loading and unloading services depend upon our customers’
            convenience, instead of our own ease. The large problem with most
            unprofessional packers and movers is that they do not have the right
            loading and unloading technique. To be precise, the difficulty is
            how the products are organized which results in major errors in
            transit. Imagine a situation when a driver applies the brakes and a
            box filled with heavier items is loaded with a couple of lighter and
            fragile items onto another one.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-body xl:w-1/2">
          ...
          <p>
            ...
            simplify all the complicated tasks related to your home relocation
            services, taking care of your goods while working with transparency
            and safety.
          </p>
          <p>
            JIT DELIVER has been rendering home relocation services which
            include assisting our clients in permanently shifting things from
            one place to a different one. Numerous people hire the house
            relocating service for shifting their house to a new place. We
            provide the house relocation service at an affordable price. Our
            experts have the knowledge to handle any quiet household goods with
            no hassle. We offer the top to finish moving and packing services.
            Our experts bring the whole thing for packing the products like
            bubble wrap, box, packing tape, scissors, etc. We’ve tons of
            experience within the house relocating services so we provide the
            best relocation services at reasonable rates.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <div className="card-body xl:w-1/2">
          ...
          <p>
            JIT DELIVER services are to relocate offices within the same city
            from one place to a different, also in different cities. We provide
            a spread of Corporate Relocation services. JIT DELIVER offers
            relocation facilities for corporate goods in all over Bangladesh.
          </p>
          <p>
            Our experience Packers and moving services help businesses find the
            best service provider deals. Expert values, customer sentiments. We
            are documented for providing extraordinary shifting services to
            customers within the industry. Relocation service providers are on
            the increase today.
          </p>
          <p>
            At a given location they shift industrial materials. Best enterprise
            hiring is the location’s daunting task. this type of service
            provider meets customer needs and measures overall stock trading.
            Moving critical materials just as monitors, papers, fax machines,
            chairs, cupboards, printers, tables, and far more is a long process.
            Professionals store all records in different boxes inside the
            office. They’re shifting to second-phase furniture. Expertise
            rearranges essential location-based things consistent with your
            convenience.
          </p>
        </div>
      </div>
