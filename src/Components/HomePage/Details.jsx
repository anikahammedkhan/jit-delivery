        ...
        <div className="mt-28 max-w-[1440px] mx-auto relative top-[500px] md:top-[-50px] lg:top-[50px] xl:top-[-50px]">
          ...
          >
            ...
            <p className="text-[20px] w-3/4 mx-auto my-2">
              ...
              আমাদেরকে সারা বাংলাদেশের যে কোনও জায়গায় অতুলনীয় হোম মুভিং
              ...
              এবং মুভিং পরিবহন পরিষেবা প্রদান করছে স্বচ্ছতার সাথে। আমরা ঢাকা
              বিভাগের শীর্ষ এবং দক্ষ প্যাকার,মুভার এবং পরিবহন শিল্পের মধ্যে
              অন্যতম। পরিবহন শিল্পের মধে পণ্য স্থানান্তর এবং অফিস স্থানান্তর
              পরিষেবাগুলির জন্য সর্বাপেক্ষা। প্যাক করা এবং পণ্য স্থানান্তর
              সর্বদা একটি ঝামেলাপূর্ণ কাজ যা আমরা আমাদের গ্রাহকদের দেখাতে চাই যে
              কীভাবে ব্যয়বহুল শিল্প কারখানার এবং গৃহস্থালী পণ্যগুলি প্রায়শই
              সুরক্ষিত থাকে। আমরা এই বিষয়ে খ্যাতি তৈরি করেছি যা আমাদের গ্রাহকদের
              বারবার আমাদের কাছে ফিরে আসতে অনুপ্রাণিত করেছে।
            </p>
          </div>
          <div className="mt-10">
            <h1 className="text-center font-bold text-[36px]">
